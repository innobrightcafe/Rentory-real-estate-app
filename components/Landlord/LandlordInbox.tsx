...
export const LandlordInbox = ({ chatSessions, user, onSelectChat }: any) => {
    return (
        <div className="py-12 space-y-8 animate-in fade-in max-w-4xl mx-auto pb-48 text-left">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-slate-900 leading-tight">Tenant Inquiries</h2>
            {chatSessions.length === 0 ? (
                <div className="text-center py-32 opacity-30">
                    <MessageSquare size={80} className="mx-auto mb-6"/>
                    <p className="text-[12px] font-black uppercase tracking-[6px]">No Messages Yet</p>
                </div>
            ) : (
                    ...
                    {chatSessions.map((session: any) => {
                        ...
                        return (
                            <Card 
                                ...
                                className="p-8 flex items-center justify-between border-none shadow-sm bg-white rounded-[2.5rem] cursor-pointer hover:shadow-xl transition-all relative"
                            >
                                <div className="flex items-center gap-6 flex-1 min-w-0">
                                    ...
                                    <div className="min-w-0 text-left">
                                        ...
                                        <p className="text-slate-500 text-sm truncate mt-1">Tenant is asking about your property.</p>
                                    </div>
                                </div>
