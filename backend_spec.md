...
### 1. System Overview
Rentory is an AI-first real estate marketplace. The backend must handle high-bandwidth image data, real-time communication, sensitive identity verification (KYC), and complex AI orchestration using the Gemini 3 API series.
